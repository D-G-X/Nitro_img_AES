                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                        onPressed:() async{
                            ...
                            print(widget.path);
                            File imageFile = File(appDocDir!.path+"/"+basename(widget.path)+".aes");
                            var delete = await imageFile.delete();
                            print("Encrypted Image Deleted.");
                            print(widget.encryptedImageFiles.remove(basename(widget.path)));
                            print("ImagePreview.dart:\t"+widget.encryptedImageFiles.length.toString());
